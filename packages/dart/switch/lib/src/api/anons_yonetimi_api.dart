...
class AnonsYonetimiApi {

  final Dio _dio;

  final Serializers _serializers;

  const AnonsYonetimiApi(this._dio, this._serializers);
  ...
  Future<Response<String>> createAnnouncement({ 
    required String name,
    required String sounddata,
    ...
    try {
      _bodyData = <String, dynamic>{
        ...
        r'sounddata': encodeQueryParameter(_serializers, sounddata, const FullType(String)),
      };
  ...
  ///
  /// Parameters:
  /// * [id] - Silinecek ses dosyasının ID değeri
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [String] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> deleteAnnouncement({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/announcements/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<GetAnnouncements200ResponseInner>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<GetAnnouncements200ResponseInner>>> getAnnouncements({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    BuiltList<GetAnnouncements200ResponseInner>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(GetAnnouncements200ResponseInner)]),
      ) as BuiltList<GetAnnouncements200ResponseInner>;
    ...
    return Response<BuiltList<GetAnnouncements200ResponseInner>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [id] - Güncellenecek ses dosyasının ID'si
  ...
  /// Returns a [Future] containing a [Response] with a [String] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> updateAnnouncement({ 
    required String id,
    String? name,
    String? sounddata,
    CancelToken? cancelToken,
    ...
    try {
      _bodyData = <String, dynamic>{
        ...
        if (sounddata != null) r'sounddata': encodeQueryParameter(_serializers, sounddata, const FullType(String)),
      };
