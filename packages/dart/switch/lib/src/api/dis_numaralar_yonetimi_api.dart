...
class DisNumaralarYonetimiApi {

  final Dio _dio;

  final Serializers _serializers;

  const DisNumaralarYonetimiApi(this._dio, this._serializers);
  ...
  Future<Response<BuiltList<String>>> getCallerIds({ 
  ...
  ///
  /// Parameters:
  /// * [extension_] - Dış numarası değiştirilecek olan dahili
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> updateOutboundCallerId({ 
    ...
    final _path = r'/update_outbound_caller_id';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      r'caller_id': encodeQueryParameter(_serializers, callerId, const FullType(String)),
    };
