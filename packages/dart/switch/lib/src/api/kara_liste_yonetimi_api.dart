...
class KaraListeYonetimiApi {

  final Dio _dio;

  final Serializers _serializers;

  const KaraListeYonetimiApi(this._dio, this._serializers);
  ...
  Future<Response<String>> createBlockedNumber({ 
    ...
    final _queryParameters = <String, dynamic>{
      r'number': encodeQueryParameter(_serializers, number, const FullType(String)),
  ...
  /// Returns a [Future] containing a [Response] with a [String] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> deleteBlockedNumber({ 
    required String number,
    String? direction,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/blocked_numbers/delete';
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ListBlockedNumbers200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ListBlockedNumbers200Response>> listBlockedNumbers({ 
    int? page,
    int? limit,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    ListBlockedNumbers200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListBlockedNumbers200Response),
      ) as ListBlockedNumbers200Response;
    ...
    return Response<ListBlockedNumbers200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
