...
class KuyrukYonetimiApi {

  final Dio _dio;

  final Serializers _serializers;

  const KuyrukYonetimiApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<GetQueueUserList200ResponseInner>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<GetQueueUserList200ResponseInner>>> getQueueUserList({ 
    ...
    final _queryParameters = <String, dynamic>{
      r'queue_number': encodeQueryParameter(_serializers, queueNumber, const FullType(String)),
    };
    ...
    BuiltList<GetQueueUserList200ResponseInner>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(GetQueueUserList200ResponseInner)]),
      ) as BuiltList<GetQueueUserList200ResponseInner>;
    ...
    return Response<BuiltList<GetQueueUserList200ResponseInner>>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<GetQueues200ResponseInner>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<GetQueues200ResponseInner>>> getQueues({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    BuiltList<GetQueues200ResponseInner>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(GetQueues200ResponseInner)]),
      ) as BuiltList<GetQueues200ResponseInner>;
    ...
    return Response<BuiltList<GetQueues200ResponseInner>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<GetQueuesPending200ResponseInner>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<GetQueuesPending200ResponseInner>>> getQueuesPending({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    BuiltList<GetQueuesPending200ResponseInner>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(GetQueuesPending200ResponseInner)]),
      ) as BuiltList<GetQueuesPending200ResponseInner>;
    ...
    return Response<BuiltList<GetQueuesPending200ResponseInner>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> manageQueueUsers({ 
    required String queueNumber,
    ...
    final _path = r'/queue/manage_users';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      r'queue_number': encodeQueryParameter(_serializers, queueNumber, const FullType(String)),
      r'user_list': encodeQueryParameter(_serializers, userList, const FullType(String)),
    };
