...
class OtomatikAramaKampanyalariApi {

  final Dio _dio;

  final Serializers _serializers;

  const OtomatikAramaKampanyalariApi(this._dio, this._serializers);
  ...
  Future<Response<String>> createIvrCampaign({ 
    required CreateIvrCampaignRequest createIvrCampaignRequest,
    ...
    final _path = r'/ivr_campaigns.json';
    ...
    try {
      const _type = FullType(CreateIvrCampaignRequest);
      _bodyData = _serializers.serialize(createIvrCampaignRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [String] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> deleteIvrCampaign({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/ivr_campaigns/{id}.json'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Parameters:
  /// * [id] - IVR Campaign ID
  /// * [status] - Kampanya durumu: \"on\" başlatmak için, \"off\" durdurmak için:  * `on`   * `off`   
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [String] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> updateIvrCampaign({ 
    required String id,
