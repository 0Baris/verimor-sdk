...
class MessagesApi {
  ...
  Future<Response<MessageResponse>> sendOtpV1MessagesOtpPost({ 
    required TemplateMessageRequest templateMessageRequest,
    String? xApiKey,
    ...
    try {
      const _type = FullType(TemplateMessageRequest);
      _bodyData = _serializers.serialize(templateMessageRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [MessageResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MessageResponse>> sendUtilityV1MessagesUtilityPost({ 
    required TemplateMessageRequest templateMessageRequest,
    String? xApiKey,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/v1/messages/utility';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        r'x-api-key': xApiKey,
