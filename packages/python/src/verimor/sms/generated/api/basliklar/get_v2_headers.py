...
def sync_detailed(
    *,
    ...
    """ Başlık Yönetimi
     ...
     Tanımlı SMS Başlıklarını listeler. Bu endpoint /v2/status, /v2/balance gibi endpoint'lerle aynı hız
    sınırı havuzunu paylaşır — dakikada toplam 20 istek gönderebilirsiniz (burst 10).
