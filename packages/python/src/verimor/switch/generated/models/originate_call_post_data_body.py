...
T = TypeVar("T", bound="OriginateCallPostDataBody")



@_attrs_define
class OriginateCallPostDataBody:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        originate_call_post_data_body = cls(
            extension=extension,
            destination=destination,
            caller_id=caller_id,
        ...
        originate_call_post_data_body.additional_properties = d
        return originate_call_post_data_body
