...
def sync_detailed(
    *,
    ...
    """ OTP / Kimlik Doğrulama Mesajı Gönder
     ...
     WhatsApp AUTHENTICATION kategorisindeki onaylı şablon ile OTP veya kimlik doğrulama mesajı gönderir.
    Yüksek öncelikli kuyruğa (`high_priority_otp`) yönlendirilir.
